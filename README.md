...
6. examine the outputs from viralrecon and explain how these could be used to decide whether the data we analysed was of sufficient quality for downstream analyses.
